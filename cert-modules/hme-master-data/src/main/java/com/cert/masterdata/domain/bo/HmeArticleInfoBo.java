...
@AutoMapper(target = HmeArticleInfo.class, reverseConvertGenerate = false)
public class HmeArticleInfoBo extends BaseEntity {
     ...
     */
    @NotBlank(message = "物料代码 (SAP, 对应PDF Material)不能为空", groups = { AddGroup.class, EditGroup.class })
